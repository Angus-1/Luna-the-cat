...
<style>
  #bg {
    ...
    background-image: linear-gradient(217deg, rgb(75, 216, 195), rgba(255,0,0,0) 70.71%),
      linear-gradient(127deg, rgb(75, 216, 195), rgba(0,255,0,0) 70.71%),
      linear-gradient(336deg, rgb(75, 216, 195), rgba(0,0,255,0) 70.71%);
  }
